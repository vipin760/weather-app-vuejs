...
<SearchLocation/>
      <div class="text-center">
        <button class="text-white shadow-lg bg-black p-2 hover:weather-secondary rounded" @click="getCurrentLocation">Check Weather Now</button>
      </div>
    ...
    <div v-if="weatherInfo">
     ...
     <div class="flex flex-col items-center text-white py-12">
       <p class="text-sm mb-2">
        ...
        <p class="text-8xl mb-8">{{Math.round(weatherInfo.current.temp)}}&deg</p>
        <p>Feels Like {{Math.round(weatherInfo.current.feels_like)}}&deg</p>
        <p class="capitalize">
         {{weatherInfo.current.weather[0].description}}
        </p>
         <img class="w-[150px] h-auto"
         :src="`http://openweathermap.org/img/wn/${weatherInfo.current.weather[0].icon}@2x.png`" alt="">
     </div>
     ...
     <div class="max-width-screen-md w-full py-12">
        <div class="mx-8 text-white">
            ...
            <div class="flex gap-10 overflow-x-scroll">
                <div v-for="hourData in weatherInfo.hourly"
                :key="hourData.dt" class="flex flex-col gap-4 items-center">
      ...
      <!-- weakly weather start-->
        ...
        <div class="mx-8 text-white">
             ...
             <div class="flex items-center" v-for="day in weatherInfo.daily" :key="day.dt">
                ...
                <img class="w-[50px] h-[50px]" :src="`http://openweathermap.org/img/wn/${day.weather[0].icon}@2x.png`" alt="">
